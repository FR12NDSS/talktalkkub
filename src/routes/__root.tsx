...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Pulse โซเชียลฟีดสั้น ๆ พร้อมสมัครสมาชิก 6 ขั้นตอน" },
      { property: "og:title", content: "Pulse — โซเชียลสั้น กระชับ ทันเหตุการณ์" },
      { property: "og:description", content: "ฟีดเรียลไทม์ เทรนด์ และการสมัครที่ง่ายใน 6 ขั้นตอน" },
